...
public class Person {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(uuid, preferredName, preferredAddress, names, addresses, birthdateEstimated, age, gender, dead, causeOfDeath, deathDate, voided, deathdateEstimated);
    }
